/*
 * Public API Surface of material-components-lib
 */

export * from './lib/material-components-lib.service';
export * from './lib/material-components-lib.component';
export * from './lib/material-components-lib.module';
